...
/* harmony import */ var ngx_chips__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngx-chips */ "./node_modules/ngx-chips/fesm2015/ngx-chips.js");
...
function createApollo(httpLink) {
    ...
    const authLink = new apollo_boost__WEBPACK_IMPORTED_MODULE_8__["ApolloLink"]((operation, forward) => {
...
let HeaderComponent = class HeaderComponent {
    constructor(config, data, element, renderer, _parserFormatter, calendar) {
        this.config = config;
        this.data = data;
...
let NgbUTCStringAdapter = class NgbUTCStringAdapter extends NgbDateAdapter {
    /**
...
let NgbDateFRParserFormatter = class NgbDateFRParserFormatter extends _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbDateParserFormatter"] {
    parse(value) {
        if (value) {
...
let TreeMapComponent = class TreeMapComponent {
    ...
    filterX(treemapdata, event) {
        return treemapdata.filter(o => Object.keys(o).some(k => o[k].toString().toLowerCase().includes(event.toString().toLowerCase())));
    }
...
/* harmony import */ var apollo_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! apollo-angular */ "./node_modules/apollo-angular/fesm2015/ngApollo.js");
...
let VerbatimComponent = class VerbatimComponent {
    constructor(data, apollo) {
        this.data = data;
        this.apollo = apollo;
        this.loading = true;
...
VerbatimComponent.ctorParameters = () => [
    { type: _data_transfer_service__WEBPACK_IMPORTED_MODULE_2__["DataTransferService"] },
    { type: apollo_angular__WEBPACK_IMPORTED_MODULE_3__["Apollo"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
