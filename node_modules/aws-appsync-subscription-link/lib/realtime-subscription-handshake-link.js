...
var AppSyncRealTimeSubscriptionHandshakeLink = /** @class */ (function (_super) {
    ...
    AppSyncRealTimeSubscriptionHandshakeLink.prototype._startSubscriptionWithAWSAppSyncRealTime = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _b, appSyncGraphqlEndpoint, authenticationType, query, variables, apiKey, region, _c, graphql_headers, credentials, jwtToken, subscriptionState, data, dataString, headerObj, _d, subscriptionMessage, stringToAWSRealTime, err_1, _e, message, _f, subscriptionFailedCallback_1, _g, subscriptionFailedCallback, subscriptionReadyCallback;
            var _this = this;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        appSyncGraphqlEndpoint = options.appSyncGraphqlEndpoint, authenticationType = options.authenticationType, query = options.query, variables = options.variables, apiKey = options.apiKey, region = options.region, _c = options.graphql_headers, graphql_headers = _c === void 0 ? function () { return ({}); } : _c, credentials = options.credentials, jwtToken = options.jwtToken;
                    ...
                    case 1:
                        headerObj = __assign.apply(void 0, _d.concat([(_h.sent()), (_b = {}, _b[aws_appsync_auth_link_1.USER_AGENT_HEADER] = aws_appsync_auth_link_1.USER_AGENT, _b)]));
                        subscriptionMessage = {
                            id: subscriptionId,
                            payload: {
                                data: dataString,
                    ...
                    case 4:
                        ...
                        observer.complete();
                        _f = (this.subscriptionObserverMap.get(subscriptionId) || {}).subscriptionFailedCallback, subscriptionFailedCallback_1 = _f === void 0 ? null : _f;
