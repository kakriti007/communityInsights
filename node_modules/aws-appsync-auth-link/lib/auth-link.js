        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    headers = __assign({}, origContext.headers, (_c = {}, _c[exports.USER_AGENT_HEADER] = exports.USER_AGENT, _c));
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    operation.setContext(__assign({}, origContext, { headers: __assign({}, origContext.headers, headers, (_b = {}, _b[exports.USER_AGENT_HEADER] = exports.USER_AGENT, _b)) }));
                    return [2 /*return*/, forward(operation)];
            }
        });
    });
